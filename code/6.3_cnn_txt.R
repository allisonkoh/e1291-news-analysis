...
result_cnn_text = confusionMatrix(pred_class_tab_text,mode="everything")
result_cnn_text = data.frame(t(result_cnn_text$byClass))
result_cnn_text$Macro = base::rowMeans(result_cnn_text)