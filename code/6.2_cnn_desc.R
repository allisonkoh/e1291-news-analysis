...
result_cnn_desc = confusionMatrix(pred_class_tab_desc,mode="everything")
result_cnn_desc = data.frame(t(result_cnn_desc$byClass))
result_cnn_desc$Macro = base::rowMeans(result_cnn_desc)