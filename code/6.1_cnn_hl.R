...
result_cnn_hl = confusionMatrix(pred_class_tab_hl,mode="everything")
result_cnn_hl = data.frame(t(result_cnn_hl$byClass))
result_cnn_hl$Macro = base::rowMeans(result_cnn_hl)